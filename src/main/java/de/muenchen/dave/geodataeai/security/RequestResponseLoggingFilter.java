package de.muenchen.dave.geodataeai.security;
...
public class RequestResponseLoggingFilter implements Filter {
     ...
     * HTTP-Request, the targeted URI and the entity http status code.
     * <p>
     * {@inheritDoc}
     */
    @Override
     ...
     *
     * @param httpServletRequest The geometry to check for logging.
